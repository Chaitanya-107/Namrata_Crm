        ...
        <div class="content">
            ...
            <form action="{{ action('StaffController@add') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="ui form">
                    ...
                    <div class="two fields">
                        <div class="field required">
                            <label>{{ trans('staff.input.label.password') }}</label>
                            <input type="password" name="password" placeholder="{{ trans('staff.input.placeholder.password') }}" required />
                        </div>
                        <div class="field required">
                            <label>{{ trans('staff.input.label.confirm_password') }}</label>
                            <input type="password" name="password_confirmation" placeholder="{{ trans('staff.input.placeholder.confirm_password') }}" required />
                        </div>
                    </div>
                    <div class="two fields">
                        <div class="field">
