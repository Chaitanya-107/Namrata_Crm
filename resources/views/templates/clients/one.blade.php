...
@section('content')
    ...
    <tr>
        ...
        <td>
            @if(isset($payment->method) && array_key_exists($payment->method, [
...
@empty
    <tr>
        <td class="center aligned" colspan="5">{{ trans('clients.table.message.empty.payments', [
            'name'  => $client->first_name
        ]) }}</td>
    </tr>
@endforelse
...
@section('modals')
    ...
    <div class="ui form">
        ...
        <!-- Rest of the form fields with proper checks -->
    </div>
</form>
