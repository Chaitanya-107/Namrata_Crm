    ...
    */
    ...
    public function add(Request $request) {
        $this->validate($request, [
            ...
            'first_name'        => 'max:32|min:3|string|required|alpha', // Ensuring only alphabetic characters are allowed
            'last_name'         => 'max:32|min:3|string|alpha', // Ensuring only alphabetic characters are allowed
            'phone'             => 'max:16|string',
            'profile_image'     => 'image',
