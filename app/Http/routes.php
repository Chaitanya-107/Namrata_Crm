...
use App\Http\Controllers\ExpiringPoliciesController;
...
// Conversions
Route::get('/conversions', [ConversionsController::class, 'index'])->name('conversions');

// Income
Route::get('/income', [IncomeController::class, 'index'])->name('income');

// Expiring Policies
Route::get('/expiring-policies', [ExpiringPoliciesController::class, 'index'])->name('expiring_policies');
